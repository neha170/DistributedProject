...
public class Main {
	public static void main(String[] args) {
		int numsAgents = 3;  // change this to run a testcase
		...
		root.isRoot = true;
		thirdExample(barrier, agentList, peers, ports);  // change this to run a testcase
	...
	// everybody points to themselves in the cycle - three cycles
	static void firstExample(CyclicBarrier barrier, ArrayList<Agent> agentList, String[] peers, int[] ports) {
		Agent agent1 = new Agent(0, new ArrayList<Integer> (Arrays.asList(1, 2, 3)), 1, peers, ports);
		Agent agent2 = new Agent(1, new ArrayList<Integer> (Arrays.asList(2, 3, 1)), 2, peers, ports);
	...
	static void secondExample(CyclicBarrier barrier, ArrayList<Agent> agentList, String[] peers, int[] ports) {
		Agent agent1 = new Agent(0, new ArrayList<Integer> (Arrays.asList(1, 2, 3)), 2, peers, ports);
		Agent agent2 = new Agent(1, new ArrayList<Integer> (Arrays.asList(2, 3, 1)), 3, peers, ports);
		Agent agent3 = new Agent(2, new ArrayList<Integer> (Arrays.asList(3, 1, 2)), 1, peers, ports);
		HashMap<Integer, Agent> pref = new HashMap<Integer, Agent>();
		agent1.setBarrier(barrier);
		agent2.setBarrier(barrier);
		agent3.setBarrier(barrier);
	...
	static void thirdExample(CyclicBarrier barrier, ArrayList<Agent> agentList, String[] peers, int[] ports) {
		Agent agent1 = new Agent(0, new ArrayList<Integer> (Arrays.asList(1, 2, 3)), 2, peers, ports);
		Agent agent2 = new Agent(1, new ArrayList<Integer> (Arrays.asList(2, 3, 1)), 1, peers, ports);
		Agent agent3 = new Agent(2, new ArrayList<Integer> (Arrays.asList(3, 1, 2)), 3, peers, ports);
		HashMap<Integer, Agent> pref = new HashMap<Integer, Agent>();
		agent1.setBarrier(barrier);
		agent2.setBarrier(barrier);
	...
	// two stages - one cycle in each
	static void fourthExample(CyclicBarrier barrier, ArrayList<Agent> agentList, String[] peers, int[] ports) {
		Agent agent1 = new Agent(0, new ArrayList<Integer> (Arrays.asList(1, 2, 3)), 2, peers, ports);
		Agent agent2 = new Agent(1, new ArrayList<Integer> (Arrays.asList(2, 3, 1)), 1, peers, ports);
		Agent agent3 = new Agent(2, new ArrayList<Integer> (Arrays.asList(1, 3, 2)), 3, peers, ports);
		HashMap<Integer, Agent> pref = new HashMap<Integer, Agent>();
		agent1.setBarrier(barrier);
		agent2.setBarrier(barrier);
		agent3.setBarrier(barrier);
